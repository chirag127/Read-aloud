...
class FloatingBar {
  ...
  setupDragging() {
    this.bar.addEventListener('mousedown', (e) => {
      ...
      if (e.target.tagName !== 'BUTTON' && e.target.tagName !== 'SVG' && e.target.tagName !== 'polygon' && e.target.tagName !== 'rect' && e.target.tagName !== 'path' && e.target.tagName !== 'circle') {
   ...
   */
  setupEventListeners() {
    const playPauseButton = document.getElementById('read-aloud-play-pause');
